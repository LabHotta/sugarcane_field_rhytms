...
modules = c("darkolivegreen1", "green3", "antiquewhite2", "blue1", "plum3", "darkviolet", "cornflowerblue", "lightskyblue3", "lightpink", "lightpink3", "lightskyblue4", "antiquewhite4", "coral4", "darkseagreen3", "lavender")
probes = names(datExpr)
