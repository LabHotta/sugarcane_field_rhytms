...
input_file <- "internode1_expressed_timecourses.txt" 
output_file <- "internode1_modules.txt" 
...
modules = c( "cornflowerblue", "chocolate3", "honeydew", "lightblue2", "royalblue3", "darkolivegreen", "mediumorchid4", "mediumpurple4", "chocolate1", "lightyellow", "lavenderblush2", "lightslateblue", "deepskyblue4", "blanchedalmond", "mistyrose3", "oldlace", "blue1", "whitesmoke", "deepskyblue", "indianred2", "deeppink2", "aliceblue", "cornsilk2", "antiquewhite4", "darkseagreen4", "plum1", "lightskyblue3", "green3", "slateblue")
probes = names(datExpr)
inModule = is.finite(match(moduleColors, modules));
modProbes = probes[inModule];
modTOM = TOM[inModule, inModule];
dimnames(modTOM) = list(modProbes, modProbes)
cyt = exportNetworkToCytoscape(modTOM, nodeFile = paste("internode1_modules", ".txt", sep=""), weighted = TRUE, threshold = 0.175, nodeNames = modProbes, nodeAttr = moduleColors[inModule]);
