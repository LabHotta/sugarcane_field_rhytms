...
input_file <- "internode1_modules.txt"
timecourses_file <- "internode1_expressed_timecourses.txt" 
output_file <- "outputs/i1_rhythmic_timecourses"
...
#separate positive correlations from negative correlations in the modules
  ...
  module_name <-sub("_", "", x)
  graphs_positive4 <- rep(paste("i1_",module_name,"01", sep = ""),nrow(graphs_positive2))
  ...
  graphs_negative4 <- rep(paste("i1_",module_name, "02", sep = ""),nrow(graphs_negative2))
...
write.table(teste13, "temp/input_modules_i1.txt", sep = "\t",quote = FALSE, row.names=FALSE, col.names = FALSE)
...
write.table(teste16, "temp/annot_modules_i1.txt", sep = "\t", quote = FALSE, row.names=FALSE, col.names = FALSE)
...
write.table(chama, "temp/i1_rhythmic_modules.txt", sep = "\t",append = TRUE, quote = FALSE, row.names = FALSE, col.names = FALSE)
write.table(chama3, "temp/i1_rhythmic_modules_timecourses.txt", sep = "\t",append = TRUE, quote = FALSE, row.names = FALSE)


rhythmic_modules <- read.table("temp/i1_rhythmic_modules.txt")
...
write.table(header, "outputs/i1_rhythmic_timecourses.txt", sep = "\t",append = TRUE, quote = FALSE, row.names = FALSE, col.names = FALSE)
apply(rhythmic_modules,1,function(x) {
                        prov <- timecourses_modules[grep(x,timecourses_modules$V16,fixed = TRUE),]
                        write.table(prov, "outputs/i1_rhythmic_timecourses.txt", sep = "\t",append = TRUE, quote = FALSE, row.names = FALSE, col.names = FALSE)
                        })
