...
input_file <- "internode5_expressed_timecourses.txt" 
output_file <- "internode5_modules.txt" 
...
modules = c("firebrick", "chocolate", "violetred4", "goldenrod2", "aquamarine", "green3", "violetred1", "firebrick1", "lightseagreen", "khaki4", "aquamarine1", "firebrick2", "burlywood", "bisque1", "dodgerblue3", "orange2", "slateblue4", "darkgoldenrod4", "darkseagreen3", "antiquewhite3", "darkseagreen2", "ivory", "blanchedalmond", "coral", "mistyrose3", "sienna4", "antiquewhite4", "dodgerblue", "dodgerblue4", "goldenrod3", "blue3", "rosybrown2", "orangered4", "lightgoldenrod4", "palevioletred1")
probes = names(datExpr)
inModule = is.finite(match(moduleColors, modules));
modProbes = probes[inModule];
modTOM = TOM[inModule, inModule];
dimnames(modTOM) = list(modProbes, modProbes)
cyt = exportNetworkToCytoscape(modTOM, nodeFile = paste("internode5_modules", ".txt", sep=""), weighted = TRUE, threshold = 0.175, nodeNames = modProbes, nodeAttr = moduleColors[inModule]);
